...
THREE_IMAGE = py.transform.scale(
    py.image.load("minesweeper/assets/three.png"), (20, 20)
)
...
SEVEN_IMAGE = py.transform.scale(
    py.image.load("minesweeper/assets/seven.png"), (20, 20)
)
EIGHT_IMAGE = py.transform.scale(
    py.image.load("minesweeper/assets/eight.png"), (20, 20)
)
